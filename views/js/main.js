...
minify with https://github.com/mishoo/UglifyJS2
*/
...
//     }
    ...
    //Created a local variable to save document.getElementsByClassName('randomPizzaContainer') outside the loop (e.g. var randomPizzaContainer'), 
...
function updatePositions() {
    ...
    var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;//removed from loop since all elements of array uses same value
